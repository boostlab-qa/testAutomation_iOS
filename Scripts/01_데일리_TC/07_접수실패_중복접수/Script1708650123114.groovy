...
// 실행할 CMD 명령어
def command = "adb shell screenrecord --time-limit 65 --output-format mp4 --size 1080x2640 --bit-rate 5000000 /sdcard/07_접수실패_중복접수.mp4"
...
'기대결과 - 중복접수 실패 팝업이 노출된다.'
Mobile.verifyElementVisible(findTestObject('운영/09_접수/tv_messageTxt', [('text') : '이미 해당 병원에 접수한 진료가 있어요']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
