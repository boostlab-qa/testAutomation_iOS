...
toggle_color2 = WebUI.getCSSValue(findTestObject('병드민설정_데일리/btn_receiptItemFalse'), 'color')
...
if(toggle_color2  == 'rgba(149, 155, 161, 1)')
	{
		'STEP - 토글 버튼 OFF 선택'
		WebUI.click(findTestObject('병드민설정_데일리/btn_receiptItemFalse'), FailureHandling.CONTINUE_ON_FAILURE)
