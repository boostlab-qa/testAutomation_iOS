...
//STEP02 - 병드민 영유아문진표 On 설정 후 토스페이 예약 신청
'STEP - 병드민 설정 테스트케이스 불러오기'
Mobile.callTestCase(findTestCase('00_병드민설정_세니티/04_병드민_세니티_예약(문진x)'), [:])
...
'기대결과 - [바로접수] 버튼이 노출된다.'
Mobile.verifyElementVisible(findTestObject('테스트/08_병원상세/btn_left', [('text') : '바로접수']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - [시간예약] 버튼이 노출된다.'
Mobile.verifyElementVisible(findTestObject('테스트/08_병원상세/btn_right', [('text') : '시간예약']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - [시간예약] 버튼 선택'
Mobile.tap(findTestObject('테스트/08_병원상세/btn_right', [('text') : '시간예약']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'STEP - 진료대상 [영유아] 선택'
Mobile.tap(findTestObject('테스트/09_접수/txt_name', [('text') : '영유아']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 하단 결제수단 영역이 노출되지 않는다.'
Mobile.verifyElementNotVisible(findTestObject('테스트/00_공통/txt_tvTitle', [('text') : '결제수단']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 홈 진료카드 영역에 [영유아검진 작성] 버튼이 노출되지 않는다.'
Mobile.verifyElementNotVisible(findTestObject('테스트/03_홈/btn_left', [('text') : '영유아검진 작성']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 진료카드 영역에 [사전문진 작성] 버튼이 노출되지 않는다.'
Mobile.verifyElementNotVisible(findTestObject('테스트/03_홈/btn_right', [('text') : '사전문진 작성']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 홈 진료카드 영역에 [자세히 보기] 버튼이 노출된다.'
Mobile.verifyElementVisible(findTestObject('테스트/03_홈/btn_large', [('text') : '자세히 보기']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 진료카드 영역 [자세히 보기] 버튼 선택'
Mobile.tap(findTestObject('테스트/03_홈/btn_large', [('text') : '자세히 보기']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 진료내역 상세 [영유아검진 작성] 버튼이 노출되지 않는다.'
Mobile.verifyElementNotVisible(findTestObject('테스트/00_공통/btn_commonBtnTitle', [('text') : '영유아검진 작성']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)

'기대결과 - 진료내역 상세 환자명이 노출된다.'
Mobile.verifyElementVisible(findTestObject('테스트/09_접수/txt_name', [('text') : '영유아']), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE)
...
'기대결과 - 결제정보 영역에 간편결제 카드 정보가 노출되지 않는다.'
Mobile.verifyElementNotVisible(findTestObject('테스트/09_접수/txt_methodAdditionalInfo', [('text') : 'KB국민은행 / 계좌']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)
...
//STEP03 - 예약 취소 후 홈 진료카드 영역 확인
'기대결과 - 홈 진료카드 영역이 노출되지 않는다.'
