...
//병드민 : 접수ON, 예약ON, 사전문진OFF, 영유아검진OFF, 간편결제ON
...
if(WebUI.waitForElementVisible(findTestObject('병드민설정_세니티/btn_receipt_use'), GlobalVariable.waitTime))
{
	'STEP - [접수 사용하기] 버튼 선택'
	WebUI.click(findTestObject('병드민설정_세니티/btn_receipt_use'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('병드민설정_세니티/btn_hospitalSetting'), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)
...
toggle_color3 = WebUI.getCSSValue(findTestObject('병드민설정_세니티/btn_infantToggleFalse'), 'color')

println(toggle_color3)

'STEP - 영유아검진 문진표 사용 여부 OFF'
if(toggle_color3  == 'rgba(149, 155, 161, 1)')
{
	'STEP - 토글 버튼 ON 선택'
	WebUI.click(findTestObject('병드민설정_세니티/btn_infantToggleFalse'), FailureHandling.CONTINUE_ON_FAILURE)
	
	WebUI.delay(2)
}

//영유아검진 1차검진 예약가능 OFF
'STEP - 영유아검진 1차검진 예약가능 사용 여부 OFF'
toggle_color = WebUI.getCSSValue(findTestObject('병드민설정_세니티/btn_infantToggleFalse_1'), 'color')
...
{
	'STEP - 토글 버튼 ON 선택'
	WebUI.click(findTestObject('병드민설정_세니티/btn_infantToggleFalse_1'), FailureHandling.CONTINUE_ON_FAILURE)
