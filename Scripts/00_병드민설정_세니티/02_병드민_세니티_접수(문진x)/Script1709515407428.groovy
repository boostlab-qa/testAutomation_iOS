...
WebUI.scrollToElement(findTestObject('병드민설정_세니티/txt_title', [('text') : '접수 사전문진']), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)

'STEP - 사전문진 [설정하기] 버튼 선택'
WebUI.click(findTestObject('병드민설정_세니티/btn_receptQuestionSetting'), FailureHandling.CONTINUE_ON_FAILURE)
...
else
{
	...
	'STEP - [똑닥 예약 사용중지] 스크롤 이동'
	WebUI.scrollToElement(findTestObject('병드민설정_세니티/btn_reserv_unsubscribe'), GlobalVariable.waitTime, FailureHandling.CONTINUE_ON_FAILURE)
	
	'STEP - [똑닥 예약 사용중지] 버튼 선택'
	WebUI.click(findTestObject('병드민설정_세니티/btn_reserv_unsubscribe'), FailureHandling.CONTINUE_ON_FAILURE)
